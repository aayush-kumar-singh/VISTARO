    ...
    <div className="w-full max-w-[1000px] mx-auto py-6 space-y-8 animate-fade-in text-vistaro-primary transition-colors duration-200">
      ...
      <div className="bg-vistaro-secondary border border-vistaro-border text-vistaro-primary rounded-3xl p-8 sm:p-12 shadow-sm relative overflow-hidden">
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <div className="text-xs text-vistaro-muted pt-2">
      ...
      {/* Terms Sections */}
      <div className="space-y-8 bg-vistaro-surface border border-vistaro-border rounded-3xl p-6 sm:p-10 shadow-xs leading-relaxed text-sm text-vistaro-secondary">

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">1.</span> Acceptance of Terms
          </h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">2.</span> Guest Bookings & Payment Terms
          </h2>
          <p>
            When booking a stay:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-vistaro-secondary text-xs sm:text-sm">
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">3.</span> Host Responsibilities & Listing Accuracy
          </h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">4.</span> Cancellation & Refund Rules
          </h2>
          <p>
            Each listing clearly specifies one of three standardized cancellation tiers:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
            <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-4 text-xs">
              <div className="font-bold text-vistaro-primary mb-1">Flexible Policy</div>
              <p className="text-vistaro-secondary">Full 100% refund for cancellations made up to 48 hours prior to scheduled check-in.</p>
            </div>
            <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-4 text-xs">
              <div className="font-bold text-vistaro-primary mb-1">Moderate Policy</div>
              <p className="text-vistaro-secondary">Full 100% refund up to 5 days before check-in; 50% refund thereafter.</p>
            </div>
            <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-4 text-xs">
              <div className="font-bold text-vistaro-primary mb-1">Strict Policy</div>
              <p className="text-vistaro-secondary">50% refund for cancellations up to 7 days before check-in; non-refundable thereafter.</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">5.</span> Governing Law & Support
          </h2>
          <p>
