    ...
    <div className="w-full max-w-[1000px] mx-auto py-6 space-y-8 animate-fade-in text-vistaro-primary transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-5 space-y-2">
          ...
          <h3 className="font-bold text-sm text-vistaro-primary">End-to-End Encryption</h3>
        ...
        <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-5 space-y-2">
          ...
          <h3 className="font-bold text-sm text-vistaro-primary">No Data Selling</h3>
          <p className="text-xs text-vistaro-secondary leading-relaxed">
        ...
        <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-5 space-y-2">
          ...
          <h3 className="font-bold text-sm text-vistaro-primary">Full User Control</h3>
          <p className="text-xs text-vistaro-secondary leading-relaxed">
      ...
      <div className="space-y-8 bg-vistaro-surface border border-vistaro-border rounded-3xl p-6 sm:p-10 shadow-xs leading-relaxed text-sm text-vistaro-secondary">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">1.</span> Information We Collect
          </h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">2.</span> How We Use Your Data
          </h2>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">3.</span> Cookies & Session Storage
          </h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-vistaro-border">
          <h2 className="text-lg font-bold text-vistaro-primary flex items-center gap-2">
            <span className="text-vistaro-accent">4.</span> Contact Our Privacy Officer
          </h2>
          <p>
            If you have questions regarding this policy or wish to exercise your data access rights, please contact us at:
          </p>
          <div className="bg-vistaro-secondary border border-vistaro-border rounded-2xl p-4 text-xs space-y-1">
